...
#DRAWING ON CANVAS MODULE
    ...
    #if detects mouse movement on the canvas
    def on_drag(event):
        x, y = event.x, event.y
        x, y = x // SETTINGS['CELL_SIZE'], y // SETTINGS['CELL_SIZE']
...
#WINDOW INITIALIZATION, PLACING THE CANVAS AND BUTTONS
    ...
    expand_grid_button = tk.Button(buttons_frame, text="Expand grid", font=button_font, width=button_width, command=expand_grid)
